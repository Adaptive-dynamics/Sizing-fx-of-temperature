...
<<mortality,fig.align='center',fig.cap='Mortality as a function of activity $\\tau$ for three levels of the mortality scaler $\\eta$',fig.width=4, fig.height=3,out.height=4,out.width=3>>=
  require(ggplot2)
